...
class SEOPerformancePredictor
{
    ...
    {
        // Implementar ajuste sazonal baseado em mês e categoria
        $month = (int)date('n');
        $categoryId = $itemData['category_id'] ?? '';
        
        // Exemplo: Eletrônicos vendem bem em novembro/dezembro (Black Friday, Natal)
        $seasonalFactors = [
            11 => 1.3, // Novembro
            12 => 1.4, // Dezembro
            1 => 0.9,  // Janeiro
    ...
    {
        // Implementar extração de keywords principais
        return array_filter(explode(' ', strtolower($title)), function($word) {
