...
$router->get('api/brand/awa/sellers/scan/history', AwaSellerController::class, 'scanHistory');
$router->get('api/brand/awa/sellers/tracked', AwaSellerController::class, 'listTrackedSellers');
$router->get('api/brand/awa/sellers/tracked/{id}', AwaSellerController::class, 'getTrackedSeller');
$router->get('api/brand/awa/sellers/tracked/{id}/items', AwaSellerController::class, 'getSellerItems');
$router->put('api/brand/awa/sellers/tracked/{id}/identify', AwaSellerController::class, 'setIdentification');
$router->post('api/brand/awa/sellers/scan', AwaSellerController::class, 'startScan');
