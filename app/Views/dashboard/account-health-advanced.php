...
<div class="card border-0 shadow-sm mb-4" id="advancedDiagnosticsPanel">
    <div class="card-header bg-gradient-primary text-white">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <button class="btn btn-sm btn-light" onclick="loadAdvancedDiagnostics()">
    ...
    <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body">
                            ...
                            <a href="#" class="btn btn-sm btn-outline-primary w-100 mt-3" onclick="showAccountStatusDetails(); return false;">
        ...
        <div id="advancedError" style="display: none;" class="alert alert-danger">
            ...
            <button class="btn btn-sm btn-outline-danger ms-3" onclick="loadAdvancedDiagnostics()">
                Tentar Novamente
            </button>
        </div>
    </div>
